...
from .views import RegisterView, LoginView, CurrencyRateViewSet, sync_currency_rate, BulkCurrencyRateView
...
urlpatterns = [
    ...
    path('v1/currency/rates/bulk/', BulkCurrencyRateView.as_view(), name='bulk_currency_rate'),  # New bulk endpoint
]
